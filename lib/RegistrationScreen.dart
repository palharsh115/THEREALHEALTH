  ...
  Widget _buildHeightField() {
    return Column(
      ...
      children: [
        ...
        _buildModernTextField(
          controller:
              isHeightInCm ? _heightCmController : _heightFeetController,
...
//     final double heightValue = isHeightInCm
//         ? double.tryParse(_heightCmController.text) ?? 0
...
//       "height": heightValue,
//       "weight": int.tryParse(_weightController.text) ?? 0,
//       "alternativePhoneNumber": _alternativePhoneNumber?.trim() ?? "",
//     };

//     print("\u{1F4E4} Sending User Data: ${jsonEncode(userData)}");
...
//       final data = jsonDecode(response.body);
//       if (response.statusCode == 201) {
//         print("\u{2705} Server Response: ${response.body}");
//         _showSnackBar("Registration successful!");
...
//         );
//       } else {
//         print("\u{26A0} Server Error: ${response.body}");
//         _showSnackBar(
//             "Failed to register: ${data['message'] ?? 'Unknown error'}");
//       }
//     } catch (e) {
//       print("\u{274C} Exception while registering: $e");
//       _showSnackBar("Error connecting to server: $e");
//     }
//   }
